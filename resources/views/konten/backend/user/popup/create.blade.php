...
<div class="row">
	...
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			{!! Form::text('nama', '', ['id' => 'nama', 'class' => 'form-control', 'placeholder' => 'nama pengguna...']) !!}
		</div>	


		<div class="form-group">
			{!! Form::label('email', 'Email : ') !!}
			{!! Form::text('email', '', ['id' => 'email', 'class' => 'form-control', 'placeholder' => 'email pengguna...']) !!}
		</div>	
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			{!! Form::select('ref_user_level_id', $level, '', ['id' => 'ref_user_level_id', 'class' => 'form-control']) !!}
		</div>
		...
		<div class="form-group">
			...
			{!! Form::password('password_confirmation',  ['id' => 'password_confirmation', 'class' => 'form-control', 'placeholder' => 're-enter Password...']) !!}
		</div>	
