...
<div class="row">
	...
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			<input type="text" id="nama" class="form-control" placeholder="nama cabang...">
		</div>	

		<div class="form-group">
			<label for="kode_cabang">Kode Cabang:</label>
			<i class='fa fa-question-circle' data-toggle='tooltip' title='3 atau 4 huruf kapital'></i>
			<input type="text" id="kode_cabang" class="form-control" placeholder="kode cabang...">
		</div>	

		<div class="form-group">
			<label for="no_tlp">Nomor Telepon Kantor Cabang:</label>
			<input type="text" id="no_tlp" class="form-control" placeholder="nomor telepon...">
		</div>
	...
	<div class="col-md-6">
		...
		<textarea id="keterangan" class="form-control" style="height:120px;"></textarea>
	</div>
	<div class="col-md-12">
		<hr>
